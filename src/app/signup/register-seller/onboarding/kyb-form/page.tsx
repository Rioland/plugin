                        ...
                        <div className="min-h-screen  px-6 py-10  bg-blend-color  w-full flex flex-col  md:flex-row gap-5 justify-center  " >
                                ...
                                {activeStep === 1 ?
                                        <div className=" w-full md:w-2/3  mx-auto md:mx-0 p-8 rounded-lg">
                                                        ...
                                                        <div className="space-y-4 ">
                                                                <div>
                                                                        ...
                                                                        <input
                                                                                ...
                                                                                className="w-full bg-[#1E1E1E] border border-gray-700 text-white p-3 rounded-md text-sm placeholder-gray-500"
                                                                        />
                                                                </div>
                                                                ...
                                                                <div>
                                                                        ...
                                                                        <textarea
                                                                                ...
                                                                                className="w-full bg-[#1E1E1E] border border-gray-700 text-white p-3 rounded-md text-sm placeholder-gray-500 h-28"
                                                                        ></textarea>
                                                                </div>
                                                        </div>
                                                </div>
                                                ...
                                                <div className="mb-8">
                                                        <h3 className="text-sm text-white font-medium mb-4">Proof of Identification</h3>
                                                        ...
                                                        <label className="w-full border border-gray-700 bg-[#1E1E1E] rounded-lg p-6 flex flex-col items-center text-sm text-gray-400 cursor-pointer hover:border-yellow-500">
                                                ...
                                                <div className="mb-8">
                                                        <h3 className="text-sm text-white font-medium mb-2">Proof of Address/Utility Bill</h3>
                                                        <p className="text-xs text-gray-400 mb-2">
                                                        ...
                                                        <label className="w-full border border-gray-700 bg-[#1E1E1E] rounded-lg p-6 flex flex-col items-center text-sm text-gray-400 cursor-pointer hover:border-yellow-500 mb-4">
                                                                <UploadCloud className="mb-2 text-yellow-500" />
                                                                Click to upload or drag and drop
                                                        ...
                                                        <form className="space-y-4">
                                                                <div>
                                                                        ...
                                                                        <input
                                                                                ...
                                                                                className="mt-1 w-full bg-gray-900 border border-gray-700 rounded-md px-4 py-3 text-sm"
                                                                        />
                                                                </div>

                                                                <div>
                                                                        <label className="text-sm font-medium">Contact phone number (with contry code )*</label>
                                                                        <div className="mt-1 flex items-center gap-2">
                                                                                {/* <div className="bg-gray-900 border border-gray-700 rounded-md px-1 py-3 flex items-center flex-row w-1/14">
                                                                                        🇳🇬 +234
                                                                                </div> */}
                                                                                <PhoneInput className='w-full bg-gray-900 border border-gray-700 rounded-md px-4 py-2 text-sm'
                                                                                        // defaultCountry="ng"
                                                                                        value={phone}
                                                                                        onChange={setPhone}
                                                                                />
                                                                                {/* <input
                                                                                        ...
                                                                                        className="w-full bg-gray-900 border border-gray-700 rounded-md px-4 py-3 text-sm"
                                                                                /> */}
                                                                        </div>
                                                                </div>
