...
const RegisterPage = () => {
  return (
    <div className="flex min-h-screen bg-gray-900 text-white">
      {/* Left Section */}
      <div className="w-1/2 bg-yellow-500 p-8 flex flex-col justify-center items-center">
        <h1 className="text-5xl font-bold mb-6">Plugin</h1>
        <p className="text-xl mb-4">Find Services That Fit Your Life</p>
      ...
      <div className="w-1/2 p-8 flex flex-col justify-center items-center">
        ...
        <form className="w-full max-w-md">
          ...
          <Input className="mb-4 w-full" type="email" placeholder="Email" />
          <Input className="mb-4 w-full" type="tel" placeholder="Phone Number" />
          <Input className="mb-4 w-full" type="password" placeholder="Password" />
...
// <h1 className="text-center text-5xl font-bold  mb-15">Seller Registration</h1>
