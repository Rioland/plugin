...
const RegisterBusinessUi = () => {
    ...
    const handleVerificationAndContinue = async () => {
        ...
        setIsLoading(true);
        setError('');
        const API_TOKEN = cookie.get('token') // IMPORTANT: Use an environment variable for this
    ...
    const handleFinalSubmit = async (e) => {
        ...
        setIsLoading(true);
        setError('');
        const API_TOKEN = cookie.get('token')
    ...
    const renderStep = () => {
        switch (activeStep) {
            case 1:
                return (<div className=" w-full md:w-2/3  mx-auto md:mx-0 p-8 rounded-lg">
            ...
            case 3:
                return (<main className="md:w-3/4">
                    <form onSubmit={handleFinalSubmit}> {/* NEW: Form element with onSubmit handler */}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-end">
                            <Button variant="outline" className="border-yellow-500 bg-transparent text-white hover:bg-yellow-600 hover:text-black" onClick={() => setActiveStep(2)}>
                                Go back
                            </Button>
