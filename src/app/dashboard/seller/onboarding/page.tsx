  ...
  return <Card className="bg-[#2C2C2C] w-full max-w-md rounded-xl shadow-lg text-center py-8 px-6 border-0 mx-auto mt-8">
    <CardContent className=''>
      ...
      <div className="text-sm text-gray-300 text-left mb-6">
        To successfully onboard as a vendor on Plugin, ensure you provide the  documents as requested.
      ...
      <Button className="bg-yellow-500 text-black w-full font-semibold py-2 rounded-md hover:bg-yellow-600" onClick={() => router.push('/dashboard/seller/onboarding/kyb-form')}>
        Get started
      </Button>
    </CardContent>
  </Card>
