...
export default function page() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <h1 className='mb-3 font-bold text-3xl'>Job review</h1>
        ...
        <div className="w-full mx-auto border border-gray-700 p-6  shadow-lg">
          <h1 className='font-bold text-2xl'>Advanced Preference (Optional) </h1>
          <p className='font-bold text-lg'>Hours per week, hire date, and more    </p>
        </div>


        <div className="w-full mx-auto border border-gray-700 p-6 rounded-br-2xl rounded-bl-2xl shadow-lg flex flex-row justify-between items-center">
          {/* back button */}
          <button className='bg-transparent text-white font-bold py-2 px-4 rounded-xl mr-4 border border-white'>Back</button>
          {/* submit button */}
          <div className='flex flex-row gap-7 '>
            <p className='font-bold text-lg'>Save as draft</p>
            <button className='bg-[#e3a325] text-black font-bold py-2 px-4 rounded-xl'>Submit Job Post</button>
          </div>
