                ...
                <div className="absolute top-full mt-0 left-0 bg-[#1f1f1f] border border-gray-700 rounded shadow-lg w-48 z-50">
                        {items.map((item, idx) => (
                                <div key={idx} className="px-4 py-2 hover:bg-[#2c2c2c] cursor-pointer text-lg" onClick={() => {
                                        if (item == 'Find Jobs') {
                                                router.push('/dashboard/seller/jobs')
                                        } else if (item == 'Saved Jobs') {
                                                router.push('/dashboard/seller/jobs/saved-jobs')
                                        }
                                        else if (item == 'Proposals') {
                                                router.push('/dashboard/seller/all-proposals')
                                        }
                                        else if (item == 'Offers') {
                                                router.push('/dashboard/seller/offers')
                                        }
                                        else if (item == 'Invites') {
                                                router.push('/dashboard/seller/invites')
                                        }
                                        else if (item == 'Active Contract') {
                                                router.push('/dashboard/seller/active-contract')
                                        }
                                        else if (item == 'Contract History') {
                                                router.push('/dashboard/seller/contract-history')
                                        }
                ...
                <div className="h-screen bg-black text-white ">
                        <header className="flex justify-between items-center px-6 py-4 border-b border-gray-800 relative">
                                ...
                                <nav className="hidden md:flex items-center gap-6 text-sm">
                                        ...
                                        <div className="cursor-pointer" onClick={() => { router.push('/dashboard/seller/wallet') }}>Wallet</div>
                                        <div className="cursor-pointer" onClick={() => { router.push('/dashboard/seller/messages') }}>Messages</div>
                                ...
                                {menuOpen && (
                                        <div className="absolute top-16 left-0 w-full bg-[#111] text-white flex flex-col items-start px-6 py-4 gap-4 md:hidden z-50 border-t border-gray-700">
                                                ...
                                                <div className="cursor-pointer"  onClick={() => { router.push('/dashboard/seller/wallet') }}>Wallet</div>
                                                <div className="cursor-pointer" onClick={() => { router.push('/dashboard/seller/messages') }}>Messages</div>
                                                <div className="cursor-pointer" onClick={() => { router.push('/dashboard/seller/profile') }}>Profile</div>
                                                <div
                                                        className="relative"
        ...
        return (
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuItem className="flex items-center gap-3 text-base font-medium cursor-pointer hover:bg-white/10 rounded-md p-2" onClick={() => { router.push('/dashboard/seller/profile') }}>
                <User className="text-yellow-400" size={20} />
                Profile
              </DropdownMenuItem>
      
              <DropdownMenuItem className="flex items-center gap-3 text-base font-medium cursor-pointer hover:bg-white/10 rounded-md p-2" onClick={() => { router.push('/dashboard/seller/settings') }}>
