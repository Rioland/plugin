                        ...
                        <div className="w-full mx-auto space-y-6 flex md:flex-row flex-col gap-6 justify-center items-center">
                                                ...
                                                <CardContent className="p-6 space-y-6">
                                                        ...
                                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                                                                <div className="flex items-center gap-2 text-sm text-gray-300">
                                                                        <span className="flex items-center gap-1"><i className="ri-time-line"></i> 1 month</span>
                                                                        <span className="flex items-center gap-1"><i className="ri-wallet-line"></i> ₦250,000 Fixed</span>
                                                                </div>
                                ...
                                <div className="w-full  md:w-1/4">
                                        ...
                                        <div className="flex flex-col w-full  gap-2 mt-4 md:mt-0">
                                                <Button className="bg-yellow-400 text-black hover:bg-yellow-500">Apply for 10 Plugs</Button>
                                                <Button variant="outline" className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black">Save Job</Button>
                                        </div>
