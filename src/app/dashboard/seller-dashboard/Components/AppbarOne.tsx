                                ...
                                <div className="flex flex-col justify-between h-full">
                                        <div>
                                                ...
                                                <nav className="space-y-4 pt-5">
                                                        ...
                                                        <SidebarItem icon={<Briefcase />} text="Jobs"  selected={pathname.endsWith('jobs') || pathname.endsWith('more-jobs') || pathname.endsWith('saved-jobs') || pathname.endsWith('job-search')}  onClick={() => { window.location.href = '/dashboard/seller-dashboard/jobs' }} />
