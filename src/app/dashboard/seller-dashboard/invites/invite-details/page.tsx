...
import DeclineInvite from "../components/DeclineInvite"
                        ...
                        <div className="bg-black text-white min-h-screen p-4 md:p-10">
                                <div className="w-full mx-auto space-y-6 flex md:flex-row flex-col gap-6 justify-center items-center">
                                        ...
                                        <div className="w-full  md:w-3/4">
                                                <div>
                                                        <h1 className="text-xl md:text-2xl font-bold mb-3">Invitation to interview</h1>
                                        ...
                                        <div className="w-full  md:w-1/4">
                                                ...
                                                <div className="flex flex-col w-full  gap-2 mt-4 md:mt-0">
                                                        <Button className="bg-yellow-400 text-black hover:bg-yellow-500 cursor-pointer" onClick={() => { setShowShowDialog(true) }}>Accept interview</Button>
                                                        <Button variant="outline" className="border-yellow-400 text-yellow-400 hover:bg-yellow-400 hover:text-black bg-transparent" onClick={()=>{ setShowDeclineDialog(true) }}>Decline interview</Button>
                                                </div>
