...
import { Paperclip, ArrowLeft, Star } from "lucide-react";
...
export default function SubmitProposalPage() {
  ...
  const [proposalSubmited, setProposalSubmited] = useState(false)
  return (
    <PluginNavbar >
      <div className="bg-black text-white min-h-screen p-4 md:p-10">
        <div className="w-full mx-auto space-y-6 flex md:flex-row flex-col gap-6 justify-center items-start">
          ...
          {proposalSubmited ? <div className="w-full  md:w-1/4">
