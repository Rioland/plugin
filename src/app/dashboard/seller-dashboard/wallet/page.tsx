...
export default function WalletPage() {
  ...
  return (
    <PluginNavbar>
          ...
          <div className=" space-y-4">
            <div className="bg-[#111] p-4 rounded-xl flex flex-col justify-start items-start text-white">
              ...
              <div className="flex gap-2 flex-col w-full">
                <Button className="bg-yellow-500 text-black hover:text-yellow-500 hover:border-yellow-500 hover:bg-transparent hover:border">Buy Plugs</Button>
                <Button variant="outline" className="border-yellow-500 text-yellow-500 bg-transparent hover:text-yellow-500">Wallet Settings</Button>
              </div>
            </div>
          </div>
        </div>
                ...
                <table className="w-full text-left">
                  ...
                  <tbody>
                    {[
                      ...
                      <tr key={i} className="border-b border-white/5" onClick={() => setOpenModal(true)}>
      ...
      <MyModal onClose={() => setOpenModal(false)} isOpen={openModal}>
        <div className="bg-black p-10 mx-auto rounded-lg text-white w-fit">
          <p className="text-white font-extrabold text-4xl mb-8">Trasaction details</p>
        <div className="mb-5">
          <p className="text-sm text-gray-400">Purchase:</p>
          <p className="text-lg text-white font-semibold">Plugs  <span className="text-yellow-500"> (200)</span></p>
          <p className="text-sm text-gray-400">Dapo David James</p>
        </div>
